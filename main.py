...
if __name__ == '__main__':
    ...
    scheduler = None
    # Set up data loaders
    training_loader, testing_loader = loadData(args.ntrain, args.ntest, args.stride, './duffing.npy', batch_size=args.batch_size, target_steps=20)
    # Init model and optimizer 
    model = KoopmanNetwork(2*args.stride, 3).to(args.device)
