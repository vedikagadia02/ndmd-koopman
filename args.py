...
class Parser(argparse.ArgumentParser):
    def __init__(self):
        ...
        # data
        self.add_argument('--ntrain', type=int, default=300, help="number of training data")
        self.add_argument('--ntest', type=int, default=100, help="number of training data")
        self.add_argument('--stride', type=int, default=1   , help="number of time-steps as encoder input")
        ...
        self.add_argument('--lr', type=float, default=0.01, help='ADAM learning rate')
